...
<head>
    ...
    <link rel="stylesheet" href="../css/kiemelesStyle.css">
    <script src="https://kit.fontawesome.com/20993e564e.js" crossorigin="anonymous"></script>
    <script defer src="../js/kiemelesScript.js"></script>
        ...
        <main>
            ...
            <section class="main_content">
                ...
                <div class="content">
                    <div class="cim">
                        <h1>Kiemelés</h1>
                        <div><b>2590 Ft / </b><span>hónap</span></div>
                    </div>
                    <div class="leiras">
                        <h2>Leírás</h2>
                    ...
                    <div class="reszletek">
                        <h2>Részletek</h2>
                        <div class="reszletekDiv">
                            <div><p>lorem:</p>&nbsp<b>Ipsum</b></div>
                            <div><p>lorem:</p>&nbsp<b>Ipsum</b></div>
                            <div><p>lorem:</p>&nbsp<b>Ipsum</b></div>
                            <div><p>lorem:</p>&nbsp<b>Ipsum</b></div>
                            <div><p>lorem:</p>&nbsp<b>Ipsum</b></div>
